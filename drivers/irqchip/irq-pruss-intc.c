			 ...
			 struct pruss_intc_config *intc_config)
{
	...
	pruss_intc_write_reg(intc, PRU_INTC_ESR(0),
			     lower_32_bits(sysevt_mask));
	pruss_intc_write_reg(intc, PRU_INTC_SECR(0),
			     lower_32_bits(sysevt_mask));
	pruss_intc_write_reg(intc, PRU_INTC_ESR(1),
			     upper_32_bits(sysevt_mask));
	pruss_intc_write_reg(intc, PRU_INTC_SECR(1),
			     upper_32_bits(sysevt_mask));
			   ...
			   struct pruss_intc_config *intc_config)
{
	...
	pruss_intc_write_reg(intc, PRU_INTC_ECR(0),
			     lower_32_bits(sysevt_mask));
	pruss_intc_write_reg(intc, PRU_INTC_ECR(1),
			     upper_32_bits(sysevt_mask));
				       ...
				       bool force)
{
	...
	pirq = intc->irqs[host - FIRST_PRU_HOST_INT];
